...
public class Rule{
     ...
     */
    public static char cellChar(Cell cell,Enemy[] enemies, Position playerCoord){
        if (playerCoord.equals(cell.getX(),cell.getY())){
            return '1';
        }
        for (int i=0;i<enemies.length;i++){
            if (enemies[i].coord.equals(cell.getX(),cell.getY())){
                return 'R';
            }
        }
    ...
    public static void enemyHit(Level level, Enemy enemy, Position newPlayer){
